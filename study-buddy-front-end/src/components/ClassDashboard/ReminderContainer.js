            ...
            <section class="mw5 mw7-ns center bg-light-gray pa3 ph5-ns">
                ...
                >
                    <Form id="reminderForm" class="pa4 pv2 black-80" onSubmit={handleSubmit}>
                        <div class="measure">
                            <label for="name" class="f6 b db mb2">Title<span class="normal black-60"></span></label>
                            <input id='name' name='name' class="input-reset ba b--black-20 pa2 mb2 db w-100" type="text" aria-describedby="title-desc" />
                        </div>
                        <div class="measure">
                            <label for="date" class="f6 b db mb2">Date<span class="normal black-60"></span></label>
                            <input id='date' name='date' class="input-reset ba b--black-20 pa2 mb2 db w-100" type="date" aria-describedby="desc-desc" />
                        </div>
                    </Form>
                </Modal>
